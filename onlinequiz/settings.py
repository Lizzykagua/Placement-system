...
EMAIL_USE_TLS = True
EMAIL_PORT = 51005
EMAIL_HOST_USER = 'lizkagua@gmail.com' # this email will be used to send emails
...
EMAIL_RECEIVING_USER = ['lizkagua@gmail.com'] # email on which you will receive messages sent from website
